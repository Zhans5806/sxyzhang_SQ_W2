// ============================================================
// Week 2 Side Quest: Platformer with Platforms Array
// ============================================================
// By: Shelisa Zhang 
// Course: GBDA 302 
// ------------------------------------------------------------
...
function drawPlayer() {
  push();
  imageMode(CENTER); // important so image is centered like your player logic
  
  // draw the image at player position
